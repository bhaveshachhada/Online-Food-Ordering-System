...
<body>
	<form method="post" action="signupquery.php" >
		...
		<div class="input-group">
			...
			<input type="text" name="contact_1" value="" placeholder="Enter your Contact here." required/>
		</div>
		<div class="input-group">
			<label>Contact-2</label>
			<input type="text" name="contact_2" value="" placeholder="Enter your Contact here." required/>
		</div>
		
			<label>Type<br></label>
			
			<input type="radio" name="provider" value="restaurant" checked/>
			Restaurant<br>
			<input type="radio" name="provider" value="local_provider">
			Local Provider<br>
		<div class="input-group">
		...
		<div class="input-group">
			...
			<input type="text" name="accout" value="" placeholder="Enter your account here." length=10 required/>
		</div>
		<div class="input-group">
